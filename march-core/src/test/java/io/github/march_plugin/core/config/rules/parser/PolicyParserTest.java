...
import io.github.march_plugin.core.config.rules.exceptions.RuleSyntaxException;
import io.github.march_plugin.core.config.rules.model.ast.LogicalExpression;
import io.github.march_plugin.core.config.rules.parser.PolicyParser;
import io.github.march_plugin.core.config.rules.parser.Token;
import io.github.march_plugin.core.config.rules.parser.TokenType;
...
class PolicyParserTest {
    ...
    void testPrecedenceAndGrouping() {
        ...
        final var partA = Mockito.mock(Dimension.Partition.class);
        final var partB = Mockito.mock(Dimension.Partition.class);
        final var partC = Mockito.mock(Dimension.Partition.class);
    ...
    void testInOperatorParsing() {
        ...
        final var uiPart = Mockito.mock(Dimension.Partition.class);
        final var apiPart = Mockito.mock(Dimension.Partition.class);
