...
import io.github.march_plugin.core.classification.model.PackageHierarchy;
...
class DefaultDenyRuleEnforcerTest {
    ...
    void setUp() {
        ...
        enforcer = new DefaultDenyRuleEnforcer(packageDependencyEvaluator, ruleEvaluator);
    }
    ...
    void enforcePackageViolationMessage() {
        ...
        final var ex = assertThrows(PackageDependencyNotAllowedException.class, () ->
                enforcer.enforceRules(Set.of(), List.of(source, target), rules));
